 ...
 */
public class CelciusToKelvinGUI extends javax.swing.JFrame {

    /**
     * Creates new form CelciusToKelvinGUI
     */
    public CelciusToKelvinGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CelciusToKelvinGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CelciusToKelvinGUI().setVisible(true);
            }
        });
    }
